"""鹿児島県銭湯組合 (kagoshima1010.com) パーサー。
...
BASE_URL = "https://kagoshima1010.com"
TOP_URL = f"{BASE_URL}/"
...
class KagoshimaParser(BaseParser):
    prefecture = "鹿児島県"
    region = "九州"
    ...
    def _is_internal_url(self, url: str) -> bool:
        ...
        return netloc in {"kagoshima1010.com", "www.kagoshima1010.com"}
