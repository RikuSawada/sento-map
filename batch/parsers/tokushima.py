"""徳島県銭湯組合 (tokushima1010.com) パーサー。
...
BASE_URL = "https://tokushima1010.com"
TOP_URL = f"{BASE_URL}/"
...
class TokushimaParser(BaseParser):
    prefecture = "徳島県"
    region = "四国"
    ...
    def _is_internal_url(self, url: str) -> bool:
        ...
        return netloc in {"tokushima1010.com", "www.tokushima1010.com"}
